...
namespace com::github::coderodde::wtpdmt::util {
	...
	size_t CommandLineParser::getNumberOfIterations() {
		return m_iterations;
	}

	DWORD CommandLineParser::getPriorityClass() {
		return m_priority_class;
	}

	int CommandLineParser::getThreadPriority() {
	...
	string CommandLineParser::getPriorityClassName(DWORD priority_class) {
	...
	string CommandLineParser::getThreadPriorityName(int thread_priority) {
	...
	size_t CommandLineParser::getMaximumPriorityClassNameLength() {
		return getMapStringKeyMaximumLength(m_priority_class_name_map);
	}

	size_t CommandLineParser::getMaximumThreadPriorityNameLength() {
	...
	static size_t CommandLineParser::getMapStringKeyMaximumLength(std::map<string, Value>& map) {
	...
	void CommandLineParser::loadDispatchMap() {
	...
	void CommandLineParser::loadPriorityClassNameMap() {
	...
	void CommandLineParser::loadThreadPriorityNameMap() {
	...
	void CommandLineParser::loadPriorityClassNumberSet() {
		for (const auto& p : m_priority_class_name_map) {
			m_priority_class_number_set.emplace(p.second);
		}
	}

	void CommandLineParser::loadThreadPriorityNumberSet() {
		for (const auto& p : m_thread_priority_name_map) {
	...
	void CommandLineParser::loadFlagSet() {
	...
	void CommandLineParser::checkFlagIsValid(string& flag) {
	...
	void CommandLineParser::checkMoreParametersAvailable() {
	...
	void CommandLineParser::processFlagPair() {
	...
	void CommandLineParser::processHelpFlags() {
		m_help_flag_present = true;
	}

	void CommandLineParser::processIterationFlags() {
	...
	void CommandLineParser::processPriorityClassFlags() {
	...
	void CommandLineParser::processThreadPriorityFlags() {
